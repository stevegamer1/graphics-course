...
void WorldRenderer::loadShaders()
{
  etna::create_program(
    ...
    {PARTICLES2_SHADERS_ROOT "static_mesh.frag.spv",
      PARTICLES2_SHADERS_ROOT "static_mesh.vert.spv"});
  etna::create_program("static_mesh", {PARTICLES2_SHADERS_ROOT "static_mesh.vert.spv"});
}
